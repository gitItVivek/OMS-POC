...
public class AuthController {
    ...
    /**
     * Used by other OMS services to resolve the authenticated user for a Bearer token.
     * Only identity-service validates JWTs and ownership of the security context.
     */
    @GetMapping("/me")
