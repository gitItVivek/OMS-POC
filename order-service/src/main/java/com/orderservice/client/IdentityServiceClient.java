    ...
    public UUID resolveUserId(String authorizationHeader) {
        ...
        try {
            ...
            throw new UnauthorizedException(
                    "Token rejected by identity-service. Login again and use a single Authorization header.");
            ...
            throw new UnauthorizedException(
                    "Identity service call failed. Check identity.service.base-url. Cause: " + e.getMessage());
        }
    }
